...
public class GeneradorPlanillas {
    ...
    public Boolean generarPlanillaUSB(PlanillaUSB p, String path) throws BadElementException, DocumentException {
        ...
        try {
            ...
            Image imagen = Image.getInstance("/home/dreabalbas/NetBeansProjects/Intercambio-II/Intercambio-II/web/images/user_data.png");
            ...
            imagen = Image.getInstance("/home/dreabalbas/NetBeansProjects/Intercambio-II/Intercambio-II/web/images/usb_logo.png");
