 ...
 * @author dreabalbas
 */
public class AccionAgregarCoordinacion extends org.apache.struts.action.Action {
    ...
    public AccionAgregarCoordinacion() {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        p.setNombre("Coordinacion de " + p.getNombreCarrera());
        p.setTipo("Coordinacion");
        p.setPrivilegio(3);
